...
public abstract class AbstractSeriesScanOperator extends AbstractDataSourceOperator {
    ...
    public TsBlock next() throws Exception {
        ...
        if(queryStateManager.isSingleScan() && queryStateManager.isHasSeriesPath(sourceId.getId())) {
            long currentEndTime = resultTsBlock.getEndTime();
            queryStateManager.updateScanTimestampByPlanNodeId(sourceId.getId(),currentEndTime);
            queryStateManager.updateScanOffsetByPlanNodeId(sourceId.getId(),currentEndTime);
        }
